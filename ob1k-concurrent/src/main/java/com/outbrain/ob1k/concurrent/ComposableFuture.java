...
public interface ComposableFuture<T> {
   ...
   */
  <R> ComposableFuture<R> flatMap(Function<? super T, ? extends ComposableFuture<R>> mapper);
   ...
   * @return a new future that will produce the original successful value the the result of the handler.
   */
  ComposableFuture<T> recoverWith(Function<Throwable, ? extends ComposableFuture<T>> recover);
   ...
   * @return a new future that will produce the result from the handler.
   */
  <R> ComposableFuture<R> alwaysWith(Function<Try<T>, ? extends ComposableFuture<R>> handler);
   ...
   */
  ComposableFuture<T> andThen(Consumer<T> consumer);
