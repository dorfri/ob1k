...
public class NingRequestBuilder implements RequestBuilder {
  ...
  public ComposableFuture<Response> asResponse() {
    ...
    return responseFuture.continueOnSuccess((FutureSuccessHandler<org.asynchttpclient.Response, Response>)
      ningResponse -> {
  ...
  public <T> ComposableFuture<TypedResponse<T>> asTypedResponse(final Type type) {
    ...
    return responseFuture.continueOnSuccess((FutureSuccessHandler<org.asynchttpclient.Response, TypedResponse<T>>)
      ningResponse -> {
